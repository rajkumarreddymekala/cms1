...
@InputType()
class UserLayoutsCreateNestedManyWithoutLayoutsItemsInput {
...
export { UserLayoutsCreateNestedManyWithoutLayoutsItemsInput as UserLayoutsCreateNestedManyWithoutLayoutsItemsInput };
