...
class LayoutsUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => LayoutSectionUpdateManyWithoutLayoutsItemsInput,
  })
  @ValidateNested()
  @Type(() => LayoutSectionUpdateManyWithoutLayoutsItemsInput)
  @IsOptional()
  @Field(() => LayoutSectionUpdateManyWithoutLayoutsItemsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => UserLayoutsUpdateManyWithoutLayoutsItemsInput,
  })
  @ValidateNested()
  @Type(() => UserLayoutsUpdateManyWithoutLayoutsItemsInput)
  @IsOptional()
  @Field(() => UserLayoutsUpdateManyWithoutLayoutsItemsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => PendingUserLayoutsUpdateManyWithoutLayoutsItemsInput,
  })
  @ValidateNested()
  @Type(() => PendingUserLayoutsUpdateManyWithoutLayoutsItemsInput)
  @IsOptional()
  @Field(() => PendingUserLayoutsUpdateManyWithoutLayoutsItemsInput, {
    nullable: true,
  })
  pendingUserLayoutsItems?: PendingUserLayoutsUpdateManyWithoutLayoutsItemsInput;
}

export { LayoutsUpdateInput as LayoutsUpdateInput };
